...
public class Quiz {
   ...
   protected int numberEnroll;
    ...
    public Quiz(int quiz_id, int creator_id, String name, String description, double price, Date last_Update, String creator_name, int questionNum, Date create_date) {
